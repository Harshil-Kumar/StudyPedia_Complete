...
async function getWordDifference(input1, input2) {
  const finalSearchTerm = "What is the difference between " + input1 + " and " + input2 + "? Give me the answer in "+ selectedOption+ " language. Dont ask any questions in return. Explain it briefly. Give me example if possible. Explain in tabular format if possible. your response must be in markdown format with emojis if possible.";
